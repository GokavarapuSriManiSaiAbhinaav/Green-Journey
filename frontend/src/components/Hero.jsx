...
const Hero = () => {
    ...
    return (
        <section className="relative bg-gradient-to-b from-green-50 to-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20 md:pt-20 md:pb-28">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">

                    {/* Left Column: Text Content */}
                    <div className="space-y-8 z-10 text-center md:text-left">
                        <h1 className="select-none text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                            Document the <br />
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 w-full sm:w-auto">
                            <button
                                ...
                                className="group w-full sm:w-auto px-8 py-4 sm:py-3.5 bg-green-600 text-white font-bold rounded-full shadow-lg hover:bg-green-700 hover:shadow-green-200/50 transition-all duration-300 flex items-center justify-center text-lg sm:text-base"
                            >
                                Explore
